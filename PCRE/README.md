...
/********************************************************************************
* Вот  программа. API  включает  понятие  «контекстов»  для установка необычных *
...
/* Выходной вектор был недостаточно большим. Этого не должно происходить, потому что мы использовали pcre2_match_data_create_from_pattern() выше. */
...
/* Показать подстроки, хранящиеся в выходном векторе, по номеру. Очевидно, что в реальном приложении вы можете захотеть делать что-то, кроме печати. */
